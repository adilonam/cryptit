        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname?.includes("dashboard") as boolean
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/forms" || pathname?.includes("forms") as boolean
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <Link
                  href="/events-stack"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname?.includes("events-stack") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/ui" || pathname?.includes("ui") as boolean}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/auth" || pathname?.includes("auth") as boolean
                }
              >
                {(handleClick, open) => {
                  return (
